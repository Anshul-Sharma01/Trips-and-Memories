    ...
    return (
        <NavigationLayout>
            <div className="min-h-screen bg-white dark:bg-gray-900">
                ...
                <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden transition-transform transform duration-300 hover:scale-105">
