                ...
                <ul className="hidden md:flex justify-center items-center space-x-6">
                    ...
                    {isLoggedIn ? (
                        <>
                            ...
                            <li><Link to="/users/friends-list" className="hover:text-teal-300 transition-colors">My Friends</Link></li>
                            ...
                            <ul className="space-y-2 mt-6 flex flex-col justify-start items-center gap-2">
                                ...
                                {isLoggedIn ? (
                                    <>
                                        ...
                                        <li><Link to="/auth/change-password" className="hover:text-teal-300 transition-colors">Change Password</Link></li>
